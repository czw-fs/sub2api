...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, settingRepository, usageLogRepository, userRPMCache, userGroupRateRepository, configConfig)
